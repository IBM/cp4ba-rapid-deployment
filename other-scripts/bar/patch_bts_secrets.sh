...
# Must begin with secret/ - see example values
dockercfgToKeep=		# example value: secret/ibm-bts-sa-dockercfg-f6thh
tokenToKeep=			# example value: secret/ibm-bts-sa-token-pw292
