...
# This script is for preparing the JiaB environment on TechZone for a shutdown. It scales down critical pods, pauses OCP updates and stops SDS.
...
echo
echo -e "\x1B[1mThis script prepares the JiaB environment on TechZone for a shutdown. It SCALES DOWN critical pods, pauses OCP updates and stops SDS. \n \x1B[0m"
...
echo
echo "Scaling down roundcubedb pods..."
oc scale deployment roundcubedb --replicas=0
echo
...
echo "All critical components got scaled down / stopped. Environment is ready for shutdown."
echo
