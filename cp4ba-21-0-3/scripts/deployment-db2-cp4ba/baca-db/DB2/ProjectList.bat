...
echo -------------------------------------------------------------------------------
@echo:
echo This script will list all ADP projects with its DB name and status
@echo:
echo -------------------------------------------------------------------------------
@echo:

set /p base_db_name= "Enter the name of the ACA Base database. If nothing is entered, we will use the default value 'BASECA': "
