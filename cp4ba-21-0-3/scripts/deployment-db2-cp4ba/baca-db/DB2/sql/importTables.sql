...
load from fonts.del of ixf lobs from ./ modified by identityignore replace into fonts;
load from fonts_transid.del of ixf lobs from ./ modified by identityignore replace into fonts_transid;
load from key_spacing.del of ixf lobs from ./ modified by identityignore replace into key_spacing;
