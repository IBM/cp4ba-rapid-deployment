...
(
	...
	config CLOB (10M) NOT NULL default '{}',
	created_ts timestamp default CURRENT_TIMESTAMP,
	last_updated_ts timestamp not null generated by default for each row on update as row change timestamp,
...
(
	...
	sensitive BOOLEAN,
	comment VARCHAR(1024),
	config CLOB (10M) NOT NULL default empty_clob(),
...
(
	...
	CONSTRAINT fonts_doc_class_id_fkey FOREIGN KEY (doc_class_id) REFERENCES doc_class (doc_class_id)
	ON UPDATE RESTRICT ON DELETE CASCADE
);
...
(
  ...
  json_model_input_detail CLOB(250M),
...
(
  ...
  accuracy real,
  version SMALLINT,
  model_output BLOB(1G),
  json_feature_vector CLOB(250M),
  json_report CLOB(250M),
	created_ts timestamp default CURRENT_TIMESTAMP,
	last_updated_ts timestamp not null generated by default for each row on update as row change timestamp,
	trainable_model_output BLOB(1G),
...
(
	...
	CONSTRAINT model_id_fkey foreign key (model_id)  REFERENCES models(id)
	ON UPDATE RESTRICT ON DELETE CASCADE
);
...
(
	...
	value_format SMALLINT NOT NULL WITH DEFAULT 1,
	extraction_tool SMALLINT NOT NULL,
	flags SMALLINT NOT NULL,
	description VARCHAR(1024),
	config CLOB (10M) NOT NULL,
	created_ts timestamp default CURRENT_TIMESTAMP,
	last_updated_ts timestamp not null generated by default for each row on update as row change timestamp,
...
-- flag 0 for training file , 1 for test file
-- create table document
-- (
--   id VARCHAR (128) NOT NULL, TRANSACTION_ID
--   name VARCHAR(1024) NOT NULL, -- mapped to FILE_NAME
--   doc_class_id VARCHAR (128) NOT NULL, --
--   num_pages SMALLINT NOT NULL,
--   upload_date BIGINT NOT NULL, mapped to INITIAL_START_TIME
--   user_uploaded VARCHAR (128) NOT NULL, mapped to user_id
--   status SMALLINT NOT NULL, renamed to MLPROCESSSTATUS
--   error_info VARCHAR(1024),  renamed to MLERROR_INFO
--   content BLOB(250M),  ----- we don't need
-- 	actual_content BLOB(250M), mapped to ORG_CONTENT
-- 	flag SMALLINT NOT NULL, use MLFLAGS
--   kvp_status smallint default 0,
-- 	TRANSACTION_ID VARCHAR(256),
--
--   CONSTRAINT doc_doc_class_id_fkey FOREIGN KEY (doc_class_id) REFERENCES doc_class (doc_class_id)
-- 	ON UPDATE RESTRICT ON DELETE CASCADE,
--
-- 	-- ADD FK to runtime_doc SB
--
...
(
  ...
  extraction_dataset     SMALLINT NOT NULL,
	...
	CONSTRAINT runtime_doc_template_fkey FOREIGN KEY (template_id) REFERENCES templates (template_id)
);
...
(
	...
	PAGE_PARAMS    CLOB(10M),
	FLATTENEDJSON  CLOB(10M),
